function plusMinus(arr) {
  ...
  const zedCount = fixDecimalToSix(zed / arr.length);
  const negCount = fixDecimalToSix(negative / arr.length);
  const posCount = fixDecimalToSix(positive / arr.length);

  console.log(posCount);
  console.log(negCount);
  console.log(zedCount);
}
function fixDecimalToSix(num) {
